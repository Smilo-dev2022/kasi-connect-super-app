...
import { EventSchema, NewEventInputSchema, UpdateEventInputSchema } from './models/event';
import { RsvpSchema, NewRsvpInputSchema, UpdateRsvpInputSchema } from './models/rsvp';
...
// Minimal OpenAPI from Zod schemas
const registry = new OpenAPIRegistry();
registry.register('Event', EventSchema);
registry.register('EventCreate', NewEventInputSchema);
registry.register('EventUpdate', UpdateEventInputSchema);
registry.register('Rsvp', RsvpSchema);
registry.register('RsvpCreate', NewRsvpInputSchema);
registry.register('RsvpUpdate', UpdateRsvpInputSchema);
const openapi = generateOpenApiDocument(registry.definitions, {
  openapi: '3.0.0',
  info: { title: 'Events Service API', version: '1.0.0' },
  servers: [{ url: '/' }],
});
