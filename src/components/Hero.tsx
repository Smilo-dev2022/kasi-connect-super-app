      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl md:text-4xl text-white/95 font-semibold mb-6 leading-tight">
            {t("hero.tagline")} 
            <span className="block text-yellow-200">{t("hero.pill")}</span>
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-12 max-w-3xl mx-auto">
            <Card className="p-6 bg-white/95 backdrop-blur-sm border-0 shadow-xl">
              ...
              <h3 className="font-semibold text-foreground mb-2">{t("hero.chat")}</h3>
              <p className="text-sm text-muted-foreground">{t("hero.chatDesc")}</p>
            </Card>
            <Card className="p-6 bg-white/95 backdrop-blur-sm border-0 shadow-xl">
              <Coins className="w-8 h-8 text-community mx-auto mb-3" />
              <h3 className="font-semibold text-foreground mb-2">{t("hero.money")}</h3>
              <p className="text-sm text-muted-foreground">{t("hero.moneyDesc")}</p>
            </Card>
            <Card className="p-6 bg-white/95 backdrop-blur-sm border-0 shadow-xl">
              <Users className="w-8 h-8 text-secondary mx-auto mb-3" />
              <h3 className="font-semibold text-foreground mb-2">{t("hero.community")}</h3>
