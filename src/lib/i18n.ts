...
const resources = {
  en: {
    translation: {
      ...
      hero: {
        tagline: "The Township Super-App for",
        taglineHighlight: "Chat • Money • Community",
        description: "A safe, verified space where people can talk, pay, save, and grow together. From stokvel payments to community safety alerts, iKasiLink brings township life into one powerful app.",
        chatTitle: "Chat",
        chatDesc: "Connect with your community safely",
        moneyTitle: "Money",
        moneyDesc: "Stokvels, savings & payments",
        communityTitle: "Community",
        communityDesc: "Safety alerts & local business",
  ...
  zu: {
    translation: {
      ...
      hero: {
        tagline: "Uhlelo Lwakho Lwe-Township Lokwenza Konke",
        taglineHighlight: "Ingxoxo • Imali • Umphakathi",
        description: "Indawo ephephile neqinisekisiwe lapho abantu bengakhuluma khona, bakhokhe, balondoloze, futhi bakhule ndawonye. Kusukela ezinkokhelweni zestokvel kuya ezexwayisweni zokuphepha komphakathi, i-iKasiLink iletha ukuphila kwalokishi ohlelweni olulodwa olunamandla.",
        chatTitle: "Ingxoxo",
        chatDesc: "Xhumana nomphakathi wakho ngokuphephile",
        moneyTitle: "Imali",
        moneyDesc: "Izitokofela, ukulondoloza nezinkokhelo",
        communityTitle: "Umphakathi",
        communityDesc: "Izexwayiso zokuphepha kanye nebhizinisi lendawo",
        joinCommunity: "Joyina Umphakathi",
